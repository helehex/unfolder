...
def test_init[type: DType]():
    ...
    # assert_equal(SmallVector[type](x1), SmallVector[type, 2](0, 1))
    assert_equal(SmallVector[type, 0](x1), SmallVector[type, 0]())
    assert_equal(SmallVector[type, 1](x1), SmallVector[type, 1](0))
    assert_equal(SmallVector[type, 2](x1), SmallVector[type, 2](0, 1))
    assert_equal(SmallVector[type, 3](x1), SmallVector[type, 3](0, 1, 0))
    # assert_equal(SmallVector[type](x1, x2), SmallVector[type, 4](0, 1, 2, 3))
    assert_equal(SmallVector[type, 0](x1, x2), SmallVector[type, 0]())
    assert_equal(SmallVector[type, 1](x1, x2), SmallVector[type, 1](0))
    assert_equal(SmallVector[type, 2](x1, x2), SmallVector[type, 2](0, 1))
    assert_equal(SmallVector[type, 3](x1, x2), SmallVector[type, 3](0, 1, 2))
    assert_equal(SmallVector[type, 4](x1, x2), SmallVector[type, 4](0, 1, 2, 3))
    assert_equal(SmallVector[type, 5](x1, x2), SmallVector[type, 5](0, 1, 2, 3, 0))
    assert_equal(SmallVector[type, 6](x1, x2), SmallVector[type, 6](0, 1, 2, 3, 0, 1))
    assert_equal(SmallVector[type, 7](x1, x2), SmallVector[type, 7](0, 1, 2, 3, 0, 1, 2))
    assert_equal(SmallVector[type, 8](x1, x2), SmallVector[type, 8](0, 1, 2, 3, 0, 1, 2, 3))
    assert_equal(SmallVector[type, 9](x1, x2), SmallVector[type, 9](0, 1, 2, 3, 0, 1, 2, 3, 0))

    # var v1 = SmallVector[type, 3](3, 2, 1)
    # var v2 = SmallVector[type, 1](0)
    # # assert_equal(SmallVector[type](v1), Vector[type, 3](3, 2, 1))
    # assert_equal(SmallVector[type, 0](v1), SmallVector[type]())
    # assert_equal(SmallVector[type](v1, size=1), SmallVector[type](3))
    # assert_equal(SmallVector[type](v1, size=2), SmallVector[type](3, 2))
    # assert_equal(SmallVector[type](v1, size=3), SmallVector[type](3, 2, 1))
    # assert_equal(SmallVector[type](v1, size=4), SmallVector[type](3, 2, 1, 3))
    # assert_equal(SmallVector[type](v1, v2), SmallVector[type](3, 2, 1, 0))
    # assert_equal(SmallVector[type](v1, v2, size=0), SmallVector[type]())
    # assert_equal(SmallVector[type](v1, v2, size=1), SmallVector[type](3))
    # assert_equal(SmallVector[type](v1, v2, size=2), SmallVector[type](3, 2))
    # assert_equal(SmallVector[type](v1, v2, size=3), SmallVector[type](3, 2, 1))
    # assert_equal(SmallVector[type](v1, v2, size=4), SmallVector[type](3, 2, 1, 0))
    # assert_equal(SmallVector[type](v1, v2, size=5), SmallVector[type](3, 2, 1, 0, 3))
    # assert_equal(SmallVector[type](v1, v2, size=6), SmallVector[type](3, 2, 1, 0, 3, 2))
    # assert_equal(SmallVector[type](v1, v2, size=7), SmallVector[type](3, 2, 1, 0, 3, 2, 1))
    # assert_equal(SmallVector[type](v1, v2, size=8), SmallVector[type](3, 2, 1, 0, 3, 2, 1, 0))
    # assert_equal(SmallVector[type](v1, v2, size=9), SmallVector[type](3, 2, 1, 0, 3, 2, 1, 0, 3))
